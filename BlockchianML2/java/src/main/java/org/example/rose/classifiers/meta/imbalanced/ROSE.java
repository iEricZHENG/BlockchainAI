package org.example.rose.classifiers.meta.imbalanced;
...
import org.example.rose.classifiers.trees.RandomSubspaceHT;
...
public class ROSE extends AbstractClassifier implements MultiClassClassifier, CapabilitiesHandler {
    ...
    private class InstancesTimestap implements Serializable {
